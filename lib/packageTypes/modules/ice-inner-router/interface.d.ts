...
export interface IceRouterPlugin {
     ...
     * @param Matcher
     */
    returnVnode: (h: CreateElement, data: any, children: any | undefined, primaryVNode: VNode, Matcher: any | RouteMatcher, parent: any, iceMatcher: IceMatcher) => VNode | undefined;
    /**
     * 给vue.prototype 添加属性
     * @param vue
     */
